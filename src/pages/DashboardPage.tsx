...
import Card, { TradeProps } from "../components/Card/Card";
                                        ...
                                        <table className="w-full my-0 align-middle text-dark border-neutral-200">
                                            <thead className="align-bottom">
                                                <tr className="font-semibold text-[0.95rem] text-secondary-dark">
                                                    <th className="pb-3 text-start min-w-[175px]">SYMBOL</th>
                                                    <th className="pb-3 text-end min-w-[100px]">TYPE</th>
                                                    <th className="pb-3 text-end min-w-[100px]">VOLUME</th>
                                                    <th className="pb-3 pr-12 text-end min-w-[175px]">PROFIT</th>
                                                    ...
                                                    <td className="p-3 pl-0">
                                                        <div className="flex items-center">
                                                            <div className="flex flex-col justify-start">
                                                                <span className="mb-1 font-semibold transition-colors duration-200 ease-in-out text-lg/normal text-secondary-inverse hover:text-primary"> Social Media API </span>
                                                            </div>
                                                        </div>
                                                    </td>
